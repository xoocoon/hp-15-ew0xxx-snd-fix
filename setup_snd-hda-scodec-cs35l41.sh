...
--- sound/pci/hda/cs35l41_hda.c.orig	2022-12-10 23:39:19.742852341 +0100
+++ sound/pci/hda/cs35l41_hda.c	2022-12-10 23:36:32.883102070 +0100
@@ -1235,6 +1235,10 @@
...
sudo dkms build -m snd-hda-scodec-cs35l41 -v 0.1
